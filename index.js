    ...
    if (interaction.isButton()) {
        ...
        if (customId === 'ticket_trust' || customId === 'ticket_report') {
            ...
            try {
                ...
                // القوانين الجديدة كاملة جوه تكت البوت
...
**3. ممنوع السبام**
مسموح جداً إنك تبعت نفس الرسالة كتير بهدف التخريب أو بدون سبب منطقي من غير ما يتعملك ميوت، وياريت تعمل كدا براحتك عشان تبسطنا.
